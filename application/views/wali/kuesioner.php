  <div class="container-fluid">
    <div class="text-center mb-5 mt-5">
      ...
      <h3 class="text-center">KUESIONER SUEVEI KEPUASAN</h3>
    </div>
    ...
    <div class="row mb-5">
      ...
      <div class="col-sm-8">
        <form id="myform" action="<?= base_url('wali/tambah_kuesioner'); ?>" method="post">
    ...
    <nav class="navbar fixed-bottom navbar-light bg-light mt-5">
      <a class="btn btn-success mr-5" href="<?= base_url('wali'); ?>">Sebelumnya</a>
      <a class="btn btn-success ml-5" href="<?= base_url('wali/lhb'); ?>">Selanjutnya</a>
    </nav>
  </div>