...
<div class="container fluid-md">
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary">Data Kuesuiner</h6>
    </div>
    <div class="card-body">
          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td><?= $n['jawaban_e']; ?></td>
                <td>
                  <a href="<?= base_url('admin/hapus_kuesioner/' . $n['id']); ?>" class="btn btn-sm btn-danger">Hapus</a>
                </td>
              </tr>
            <?php
              $no++;
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="<?= base_url('admin/data_kuesioner'); ?>" method="post">
